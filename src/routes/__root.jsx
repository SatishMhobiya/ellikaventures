...
function NotFoundComponent() {
    return (<div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-8">
          <Link to="/" className="inline-flex items-center justify-center rounded-md bg-gradient-brand px-6 py-3 text-xs uppercase tracking-[0.22em] text-brand-foreground">
            Go home
          </Link>
        </div>
      </div>
    ...
    return (<div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          ...
          <a href="/" className="rounded-md border border-border px-6 py-3 text-xs uppercase tracking-[0.22em]">
            Go home
          </a>
        </div>
      </div>
