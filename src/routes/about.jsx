...
const description = "Ellikaventures is a RERA-authorised Bengaluru real estate channel partner led by directors with 10+ years of experience, bridging developers and investors.";
...
function About() {
    return (<div className="mx-auto max-w-7xl px-6 pb-28 pt-36 lg:px-10 lg:pt-44">
      ...
      <div className="mt-14 grid gap-14 lg:grid-cols-2">
        ...
        <img src={interior} alt="Ivory and champagne gold residence interior" width={1400} height={1000} loading="lazy" className="h-full w-full rounded-lg object-cover shadow-lift"/>
      </div>
